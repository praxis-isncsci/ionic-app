...
import { manOutline, documentOutline, saveOutline, calculatorOutline, chevronUp, newspaperOutline, bookmarksOutline, downloadOutline, mailOutline, bulbOutline } from 'ionicons/icons';
