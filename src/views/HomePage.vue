        ...
        <praxis-isncsci-classification slot="classification" ref="classificationRef">
          ...
          <praxis-isncsci-classification-grid slot="neurological-levels" class="classification-grid">
            ...
            <div slot="grid">
              ...
              <praxis-isncsci-classification-total data-total="right-motor">&nbsp;</praxis-isncsci-classification-total>
              <praxis-isncsci-classification-total data-total="left-motor">&nbsp;</praxis-isncsci-classification-total>
            </div>
