    ...
    <ion-content :fullscreen="true">
      ...
      <div id="container">
        <praxis-isncsci-web-app>
          <praxis-isncsci-app-layout classification-style="static">
            <praxis-isncsci-app-bar slot="app-bar">
              <button class="button icon-button" slot="menu-button">
                <praxis-isncsci-icon href="Content/icons/regular.svg#icon-hamburger-menu-24"
                  size="24"></praxis-isncsci-icon>
              </button>
              <span slot="title">&nbsp;</span>
              <div slot="actions">
                <button class="button" action-calculate>
                  <praxis-isncsci-icon href="Content/icons/regular.svg#icon-calculator-20"
                    size="20"></praxis-isncsci-icon>
                  Calculate
                </button>
              </div>
            ...
            <praxis-isncsci-input-layout slot="input-layout">
              ...
              <select name="right-lowest" id="right-lowest" slot="right-lowest">
                <option value="None"></option>
                <option value="C5">C5 - Shoulder: Flexion, extension, abduction, adduction, internal and external rotation
                  - Elbow: Supination</option>
                <option value="C6">C6 - Elbow: Pronation - Wrist: Flexion</option>
                <option value="C7">C7 - Finger: Flexion at proximal joint, extension. Thumb: Flexion, extension and
                  abduction in plane of thumb</option>
                <option value="C8">C8 - Finger: Flexion at MCP joint Thumb: Opposition, adduction and abduction
                  perpendicular to palm</option>
                ...
                <option value="L4">L4 - Hip: Extension, abduction, internal rotation - Knee: Flexion - Ankle: Inversion
                  and eversion - Toe: MP and IP extension</option>
            ...
            <praxis-isncsci-input slot="input-controls" disabled>
              ...
              <label for="reason-for-impairment-not-due-to-sci" slot="reason-for-impairment-not-due-to-sci-label">If motor
                impairment not due to SCI, please indicate reason:</label>
            ...
            <praxis-isncsci-classification slot="classification">
              <praxis-isncsci-dialog-header slot="header">
                ...
                <div slot="close">
                  <button class="button icon-button" action-close-classification>
                    <praxis-isncsci-icon href="Content/icons/regular.svg#icon-close-24" size="24"></praxis-isncsci-icon>
                  </button>
                </div>
              ...
              <praxis-isncsci-classification-grid slot="sub-scores">
                ...
                <div slot="grid">
                  ...
                  <praxis-isncsci-classification-total
                    data-total="touch-total">&nbsp;</praxis-isncsci-classification-total>
...
/* ISNCSCI UI */
import 'isncsci-ui/web/esm/index.js';
import 'isncsci-ui/css/design-system.css';
</script>
